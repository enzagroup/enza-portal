import{p as s,j as e}from"./entry.client-BgxK5DzO.js";const d="This document outlines how enza manages versioning for the TX API and its documentation.",o=[{depth:1,text:"Versioning Policy",id:"versioning-policy",children:[{depth:2,text:"API Version",id:"api-version",children:[{depth:3,text:"When We Create a New API Version",id:"when-we-create-a-new-api-version"}]},{depth:2,text:"Documentation Version",id:"documentation-version"},{depth:2,text:"Changelog",id:"changelog"},{depth:2,text:"Support Policy",id:"support-policy"}]}],c={lastModifiedTime:"2026-04-29T21:17:18.000Z"},h="pages/versioning.mdx";function r(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"versioning-policy",children:"Versioning Policy"}),`
...
//# sourceMappingURL=versioning-BjH7t5qK.js.map
